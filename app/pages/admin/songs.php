	...
	<section class="admin-content" style="min-height: 200px;">
  		...
  		<?php if($action == 'add'):?>
  			...
  			<div style="max-width: 500px;margin: auto;">
	  			<form method="post" enctype="multipart/form-data">
	  				...
	  				<input name="title" class="form-control my-1" value="<?=set_value('title')?>" type="text" title="title" placeholder="zene cím">
					...
					<div class="form-control my-1">
	  				...
	  				<button class="btn bg-orange">Mentés</button>
	  				<a href="<?=ROOT?>/admin/songs">
	  					<button type="button" class="float-end btn">Vissza</button>
	  				</a>
	  			</form>
	  		</div>
  			...
  			<div style="max-width: 500px;margin: auto;">
	  			<form method="post" enctype="multipart/form-data">
	  				...
	  				<?php if(!empty($row)):?>
	  					  				...
	  					  				<input name="title" class="form-control my-1" value="<?=set_value('title',$row['title'])?>" type="text" title="title" placeholder="zene cím">
	  				<?php if(!empty($errors['title'])):?>
	  					<small class="error"><?=$errors['title']?></small>
	  				<?php endif;?>
					...
					<div class="form-control my-1">
	  				...
	  				<?php else:?>
	  					<div class="alert">Nem található</div>
	  					<a href="<?=ROOT?>/admin/songs">
		  					<button type="button" class="float-end btn">Vissza</button>
		  				</a>
	  				<?php endif;?>
  		...
  		<?php elseif($action == 'delete'):?>
  			...
  			<div style="max-width: 500px;margin: auto;">
	  			<form method="post">
	  				...
	  				<button class="btn bg-red">Törlés</button>
	  				<a href="<?=ROOT?>/admin/songs">
	  					<button type="button" class="float-end btn">Vissza</button>
	  				</a>
  		...
  		<?php else:?>
  			...
  			<h3>Songs
  				<a href="<?=ROOT?>/admin/songs/add">
  					<button class="float-end btn bg-purple">Új hozzáadása</button>
  				</a>
  			</h3>
  	...
  	<div class="mx-2">
		<a href="<?=ROOT?>/admin/songs?page=<?=$prev_page?>">
			<button class="btn bg-orange">Előző</button>
		</a>
		<a href="<?=ROOT?>/admin/songs?page=<?=$next_page?>">
			<button class="float-end btn bg-orange">Következő</button>
		</a>
	</div>
